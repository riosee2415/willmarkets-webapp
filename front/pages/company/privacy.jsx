        ...
        {i18next.language === "ko" ? (
          <RsWrapper padding={width < 1100 ? `50px 60px` : `50px 245px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                이 개인 정보 보호 정책은 EU에 거주하는 자연인의 개인 데이터를
                회사에서 처리하고 보호하는 방법에 대한 정보를 제공합니다.
              </Content>
            </SubTitle>
            <Content padding={`40px`} padding={`10px 0 0 26px`}>
              회사 웹사이트에 접속하여 서비스 이용을 신청하는 EU 거주자는 사전에
              본 개인정보 보호정책을 읽고 동의해야 합니다. 이 웹사이트 또는
              서비스에 계속 액세스하고 사용함으로써 귀하는 당사의 개인정보
              보호정책에 동의함을 명시적으로 확인하는 것입니다.
            </Content>
            <Title>
              <Wrapper className={`number`} width={`auto`}>
                2
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                ...
                처리합니다. 아래 목록은 완전하지 않으며 필요에 따라 회사는 개인
                정보 보호 정책 및 기타 관련 법률 제정에 따라 다른 개인 데이터를
                처리할 수 있습니다.
              </Content>
            </SubTitle>
            <SubTitle
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `14px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                – 이름, 성, 세금 식별 번호, 생년월일, 식별 문서 세부 정보(예:
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `14px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                – 교육, 직장, 직업, 사업 활동(있는 경우), 고용주(있는 경우)에
                관한 정보
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `14px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                관련된 정보 – 사용된 서비스, 개인 설정, 설문조사, 콘테스트 및
                고객이 참여한 캠페인에 대한 정보
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `14px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                – 고객 계정에 연결된 개인 및 법인(예: POA 소지자, 승인된 사용자
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `14px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                – 인터넷 프로토콜(IP) 주소, 로그인 정보, 브라우저 정보, 시간대
                등
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `14px 0 0 90px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                고객 개인 데이터는 주로 유럽 경제 지역(EEA)과 스위스 연방 내에서
                처리됩니다. 그러나 필요한 경우 이 개인정보 보호정책에 명시된
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                회사는 적절한 보호 장치가 마련되어 있고 다음 중 하나가 적용되는
                경우에만 EEA 또는 스위스 연방 외부에서 처리하기 위해 고객 개인
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                개인 데이터의 보유 기간을 결정할 때 회사는 계약상의 의무, 회사의
                정당한 이익 및 관련 법률 제정(예: 자금 세탁 방지 및 테러 자금
                조달에 관한 규정)을 고려합니다.
              </Content>
            </SubTitle>
            <Title>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                서면 요청 시 고객은 회사에서 처리하는 개인 데이터의 사본을 받을
                수 있습니다. 그러한 요청이 과도하거나 반복적일 경우, 회사는
                고객의 개인 데이터 사본 제공을 거부할 수 있으며 회사는 그러한
                사본을 준비하는 데 필요한 자원을 고려하여 합리적인 비용을 요청할
                수 있습니다.
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                고객은 회사에 적용되는 법률 및 기타 규정이 허용하는 범위 내에서
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                귀하의 요청이나 우려 사항이 당사에서 만족스럽게 해결되지 않은
                경우 귀하의 서면 요청에 따라 라트비아 공화국의 데이터 상태
                검사관(Data State Inspectorate)에 접근할 수 있습니다.
              </Content>
            </SubTitle>
            <Title>
              <Wrapper className={`number`} width={`auto`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                쿠키는 웹사이트를 방문하는 동안 브라우저에 배치되는 작은 시스템
                파일을 기반으로 하는 기술입니다.
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                회사는 Google Analytics와 같은 제3자 웹 분석 서비스에서 제공하는
                제3자 쿠키를 사용합니다.
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                고객은 회사가 고객에게 사전 통지 없이 언제든지 개인 정보 보호
                정책을 변경할 권리가 있다는 데 동의합니다. 회사는 웹사이트를
                자유롭게 사용하여 개인정보 보호정책의 변경 사항을 고객에게 알릴
                수 있습니다. 회사 웹사이트에 업데이트된 개인정보 보호정책 버전을
                게시하는 것은 고객에게 유효한 변경 통지로 간주됩니다. 고객은
                회사의 웹사이트와 개인정보 보호정책 업데이트를 정기적으로 검토할
                것을 약속합니다.
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                개인 정보 보호 정책의 수정 사항은 개인 정보 보호 정책에 명시된
                날짜에 발효됩니다.
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
          ...
          <RsWrapper padding={width < 1100 ? `50px 100px` : `50px 245px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                This Privacy Policy provides information on the processing and
                protection by the Company of personal data of natural persons
                residing in the EU.
              </Content>
            </SubTitle>
            <Content padding={`40px`} padding={`10px 0 0 26px`}>
              EU residents accessing the Company's websites and applying for
              using its services shall preliminarily read and accept the present
              Privacy Policy. By continuing to access and use this website or
              services you expressly confirm your acceptance of our Privacy
              Policy.
            </Content>
            <Title>
              <Wrapper className={`number`} width={`auto`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                ...
                limited to collection, recording, storage, transfer, erasure,
                etc.;
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                ...
                specified under Section 4. Please note that the below list is
                not exhaustive and upon necessity the Company may process other
                Personal Data, according to its Privacy Policy and other
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `14px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                identification number, date of birth, details of identification
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `0px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                – account number, account balance, income, wealth, transactions
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `0px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                – individuals and legal entities connected to the Client account
                (e.g. POA holders, authorised users, etc.), originators or
            ...
            <SubTitle
              ...
              <Content width={`calc(100% - 70px)`}>
                Information collected automatically while using the Website or
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `0px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                – Internet protocol (IP) address, login information, information
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 50px` : `0px 0 0 90px`}>
              ...
              <Content width={`calc(100% - 70px)`}>
                ...
                used by the Company’s websites and its mobile applications. For
                more detailed information on the types of cookies and unique
                identifiers the Company use and for which purposes, please refer
                to Section 10.
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                It is the duty of the Client of informing third parties of this
                Privacy Policy in case he passes to the Company Personal Data
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 35px` : `14px 0 0 63px`}>
              <Content width={`calc(100% - 70px)`}>
                ...
                the processing of Personal Data is necessary to enter into and
                perform a contract;
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `0 0 0 35px` : `0 0 0 63px`}>
            ...
            <SubTitle padding={width < 800 ? `0 0 0 35px` : `0 0 0 63px`}>
              <Content width={`calc(100% - 70px)`}>
                ...
                to protect the legitimate interests of the Company or of third
                party;
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `0 0 0 35px` : `0 0 0 63px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The Company primarily processes Personal Data for the following
                purposes:
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `0 0 0 35px` : `0 0 0 63px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The Company is entitled to disclose Client’s Personal Data to
            ...
            <SubTitle padding={width < 800 ? `0 0 0 35px` : `0 0 0 63px`}>
              <Content width={`calc(100% - 70px)`}>
                ...
                services, data analysis, marketing support, cloud services and
                others;
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `0 0 0 35px` : `0 0 0 63px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The Company transfers or makes Client Personal Data accessible
                for processing outside the EEA or the Swiss Confederation only
                when appropriate safeguards are in place and if one of the
                following applies:
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `0 0 0 35px` : `0 0 0 63px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The period of retention of Personal Data depends on the purposes
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                ...
                legitimate interest of the Company and relevant legal enactments
                (such as the regulation concerning anti-money laundering and
                terrorism financing).
              </Content>
            </SubTitle>
            <Title>
            ...
            <Content padding={`40px`} padding={`10px 0 0 43px`}>
              ...
              information, for example the login and password either
              communicated to this third party by the Client or obtained by the
              third party from the Client by an abusive/fraudulent manner. The
              Client shall be solely liable for any such personal data
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                ...
                Personal Data that are processed by the Company. If such request
                is excessive or repetitive, the Company may refuse to provide
                the Client with copy of his Personal Data and the Company may
                request a reasonable fee taking into account the necessary
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The Client may request the Company to erase his Personal Data to
                the extent permitted by law and other regulation applicable to
                the Company;
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The Client may restrict the processing of his Personal Data by
                the Company to the extent permitted by law and other regulation
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                ...
                structured, commonly used and electronic format as well as to
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                All aforementioned rights should be exercised in good faith and
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                If your request or concern is not satisfactorily resolved by us,
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The Company collects information about visitor’s device and uses
                cookies to:
              </Content>
            </SubTitle>
            <SubTitle padding={width < 800 ? `14px 0 0 35px` : `14px 0 0 63px`}>
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The Company uses third party cookies, provided by third party
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                ...
                Privacy Policy at any time without prior notice to the Client.
                The Company may freely use its Websites to inform the Client
                about any changes in the Privacy Policy. The publishing of an
                updated version of the Privacy Policy on the Company’s
                website(s) shall be deemed a valid notification of changes to
                the Client. The Client undertakes to regularly review the
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                The amendments to the Privacy Policy shall become effective on
            ...
            <SubTitle padding={width < 800 ? `14px 0 0 10px` : `14px 0 0 43px`}>
              ...
              <Content width={`calc(100% - 60px)`}>
                This Privacy Policy was last updated on the date indicated at
                the top. It supersedes all previous versions.
              </Content>
            </SubTitle>
          </RsWrapper>
        )}
