        ...
        <Wrapper
          ...
          <PreText>
            {i18next.language === `en`
              ...
              : `  웰마켓의 개인정보보호정책 
              1.소개 ○1 
              당사는 귀하의 개인 데이터를 보호하고 보호하기 위해 최선을 다하고 있습니다.
                
                WILL-MARKETS 의 현재 개인정보 보호 정책은 유럽 연합 거주자에게 혜택을 제공하는 EU 의 일반
                데이터 보호 규정(GDPR)에 비추어 시행되었습니다. ○2 본 개인정보
                보호정책은 EU 에 거주하는 자연인의 개인정보처리 및 보호에 관한
                정보를 제공합니다. 회사의 웹사이트에 접속하고 서비스 이용을 신청하는
                EU 거주자는 본 개인정보 보호정책을 예열적으로 읽고 수락해야 합니다.
                이 웹 사이트 또는 서비스에 계속 액세스하고 사용함으로써 귀하는
                당사의 개인 정보 보호 정책에 대한 귀하의 동의를 명시적으로
                확인합니다. 2.정의 ○1 고객 – 회사가 제공하는 서비스 및 기타 온라인
                리소스(예: 콘테스트, 온라인 커뮤니티 등)를 사용하거나 기꺼이
                사용하겠다는 의사를 밝힌 자연인; ○2 개인정보 보호정책 – WILL-MARKETS
                본 개인정보 보호정책; ○3 개인 데이터 - 식별된 개인 또는 식별 가능한
                개인과 관련된 모든 정보. 자세한 내용은 섹션 3 을 참조하십시오. ○4
                처리 – 예를 들어 개인 데이터와 관련된 모든 행위는 수집, 기록, 저장,
                전송, 삭제 등에 국한되지 않습니다. ○5 서비스 – 회사가 제공하는 모든
                서비스; ○6 웹사이트 – www.will-markets.com 3 회사가 처리하는 개인
                데이터 범주 ○1 회사는 섹션 4 에 명시된 목적을 위해 특정 개인
                데이터를 처리합니다. 아래 목록은 완전하지 않으며, 필요에 따라 회사는
                개인정보 보호정책 및 기타 관련 법률 제정에 따라 기타 개인 데이터를
                처리할 수 있습니다. 1. 클라이언트로부터 받은 개인 데이터: 1. 이름,
                성, 세금 식별 번호, 생년월일, 신분증 세부 정보(예: 여권 번호 또는
                사본)를 포함하되 이에 국한되지 않는 자연인 식별 데이터 2. 연락처
                정보 – 주소, 전화 번호, 전자 메일 주소 및 기타 관련이 있는 경우; 3.
                재무 정보 – 계정 번호, 계정 잔액, 소득, 부, 거래 및 기타 유사한
                정보; 4. 자금의 배경 및 출처 - 교육, 직장, 직업, 비즈니스 활동에
                관한 정보, 고용주가 있는 경우; 5. 서비스 이용 및 고객 선호도, 습관
                등에 대한 관계와 관련된 정보 – 사용되는 서비스, 개인 설정, 설문
                조사, 콘테스트 및 고객이 참여한 캠페인에 대한 정보와 같은 경우 6.
                결혼 여부 및 관련 제 3 자 – 고객 계정에 연결된 개인 및 법인(예: POA
                소지자, 공인 된 사용자 등), 고객 거래의 출발자 또는 수혜자 등 2.
                회사가 운영하거나 소유한 웹사이트 또는 모바일 또는 온라인
                애플리케이션을 사용하는 동안 자동으로 수집된 정보: 1. 기술 정보 및
                고유 식별자 – 인터넷 프로토콜(IP) 주소, 로그인 정보, 브라우저,
                시간대 등에 대한 정보; 2. 회사의 웹 사이트 및 모바일 응용
                프로그램에서 사용하는 쿠키. 회사가 사용하는 쿠키 및 고유 식별자의
                유형및 목적에 대한 자세한 내용은 섹션 10 을 참조하십시오. 2. 제 3
                자와 관련된 회사 개인 데이터를 전달할 경우 본 개인정보 보호정책의 제
                3 자에게 알리는 것은 고객의 의무입니다. 1. 개인정보 처리 근거 및
                목적 1. 회사는 다음 중 하나가 적용되는 경우 개인 데이터를
                처리합니다. 1. 계약을 체결하고 수행하기 위해서는 개인 데이터 처리가
                필요합니다. 2. 회사의 법적 의무를 준수하기 위해 3. 회사 또는 제 3
                자의 정당한 이익을 보호하기 위해 4. 회사가 고객의 동의를 받는 경우.
                2. 회사는 주로 다음과 같은 목적으로 개인 데이터를 처리합니다. 1.
                서비스를 무료로 제공하고 온라인 및 모바일 리소스를 무료로
                제공합니다. 2. 정책 업데이트 및 계약 약관 변경 사항을 포함한 관리
                정보를 전송하는 행위 3. Dukascopy Group 제공 및 기타 리소스와
                관련하여 고객에게 유용할 수 있는 서비스, 제품, 교육 자료, 예정된
                이벤트 및 기타 관련 정보에 대한 정보를 고객에게 제공하기 위해; 4.
                자금 세탁 방지 및 테러 자금 조달과 관련된 위험뿐만 아니라 거래 관련
                위험을 평가하고 완화하기 위해; 5. 법적 의무 및/또는 정부 당국의
                요청을 준수하기 위해; 6. 회사의 정당한 이익과 관련하여. 2. 고객 개인
                데이터 공개 1. 회사는 고객의 개인정보를 다음과 같은 선택된 제 3
                자에게 공개할 권리가 있습니다. 1. WILL-MARKETS 그룹 내에서, 회사의
                모든 사무실과 계열사를 포함, 지리적 위치에 관계없이; 2. 개인 데이터
                처리와 관련하여 적절한 보호 장치 및 제한을 보장하는 서면 계약에 따라
                WILL-MARKETS 에 서비스를 제공하는 제공업체를 포함하여 선택된 제 3
                자에게. 여기에는 IT, 결제 서비스, 감사 서비스, 신원 확인, 실사
                서비스, 데이터 분석, 마케팅 지원, 클라우드 서비스 등을 제공하는
                회사가 포함될 수 있습니다. 3. 정부, 규제 또는 기타 법 집행 기관/
                당국에 대한 권한을 가진 다. 3. 개인 데이터 전송 1. 클라이언트 개인
                데이터는 주로 유럽 경제 지역(EEA) 및 스위스 연맹 내에서 처리됩니다.
                그러나 필요한 경우 개인 데이터는 본 개인정보 보호정책에 명시된 대로
                제 3 국으로 전송될 수 있습니다. 2. 회사는 적절한 안전 장치가 마련된
                경우에만 EEA 또는 스위스 연맹 외부에서 처리하기 위해 클라이언트 개인
                데이터를 전송하거나 액세스할 수 있도록 하며 다음 중 하나가 적용되는
                경우에만 다음 중 하나가 적용되는 경우에만 사용할 수 있습니다. 1.
                이는 법률 및 규정에 따라 요구됩니다. 2. 이는 서비스에 대한 계약을
                체결하거나 이행하기 위해 필요합니다. 3. 고객은 EEA 외부에서 자신의
                데이터를 처리하는 데 동의했습니다. 4. 보존 기간 1. 개인정보 보유
                기간은 회사가 지정한 목적에 따라 다릅니다. 2. 회사는
                개인정보보유기간을 결정할 때 계약상 의무, 회사의 정당한 이익, 관련
                법률 제정(예: 자금세탁 방지 및 테러자금 조달에 관한 규정)을
                고려합니다. 5. 고객의 의무 고객은 고객의 기밀 정보의 제 3 자가
                사용하는 경우, 예를 들어 고객이 이 제 3 자에게 전달하거나 고객이
                고객으로부터 얻은 로그인 및 비밀번호와 같이 금융을 포함한 모든
                종류의 손실에 대해 회사 또는 WILL-MARKETS 또는 임원, 이사, 직원 및
                계열사를 보유하지 않기로 동의합니다. 고객은 승인되지 않은 제 3
                자에게 그러한 개인 데이터 공개에 대해전적으로 책임을 집니다. 6.
                고객의 권리 1. 서면 요청시 고객은 회사가 처리하는 개인 데이터의
                사본을 받을 수 있습니다. 이러한 요청이 과도하거나 반복적인 경우
                회사는 고객에게 개인 데이터의 사본을 제공하는 것을 거부할 수 있으며,
                회사는 해당 사본을 준비하는 데 필요한 자원을 고려하여 합리적인
                수수료를 요구할 수 있습니다. 2. 고객은 회사에 자신의 개인 데이터를
                수정하도록 요청할 수 있습니다. 3. 고객은 회사가 적용되는 법률 및
                기타 규정에서 허용하는 범위 내에서 자신의 개인 데이터를 삭제하도록
                요청할 수 있습니다. 4. 고객은 회사가 허용하는 범위 내에서 회사가
                자신의 개인정보 처리및 기타 규정이 적용되는 범위 내에서 제한할 수
                있습니다. 5. 클라이언트는 구조화되고 일반적으로 사용되는 전자
                형식으로 개인 데이터를 수신하고 다른 컨트롤러에게 전송할 권리가
                있습니다. 6. 앞서 언급한 모든 권리는 선의와 서면 요청에 따라
                행사되어야 한다. 7. 귀하의 요청이나 우려가 당사에 의해 만족스럽게
                해결되지 않는 경우, 귀하의 서면 요구에 따라 라트비아 공화국의 데이터
                국가 검사에 접근할 수 있습니다. 7. 쿠키 1. 회사는 쿠키와 같은
                모니터링 기술을 사용하여 방문자에게 웹사이트의 효율적인 운영을
                제공합니다. 2. 쿠키는 웹 사이트를 방문하는 동안 브라우저에 배치 된
                작은 시스템 파일을 기반으로 기술입니다. 3. 회사는 방문자의 기기에
                대한 정보를 수집하고 쿠키를 사용하여 다음을 수행합니다. 1. 회사의 웹
                사이트 기능을 사용자 정의; 2. 방문자의 데이터의 재입국을 피하십시오.
                3. 매장 방문자의 취향; 4. 웹사이트 사용에 대한 정보를 수집합니다. 4.
                회사는 구글 애널리틱스와 같은 제 3 자 웹 분석 서비스에서 제공하는 제
                3 자 쿠키를 사용합니다. 5. 클라이언트 및 웹사이트 방문자는 브라우저
                기본 설정을 구성하고 쿠키를 수락하지 않을 수 있지만 이는 웹 사이트의
                기능에 영향을 줄 수 있습니다. 8. 연락처 정보 고객이 회사가 개인
                데이터 처리에 관한 질문이나 문의사항이 있는 경우,
                www.will-markets.com 또는 help@will-markets.com 편지를 보내야
                합니다. 9. 최종 조항 1. 고객은 고객에게 사전 통보 없이 언제든지
                개인정보 취급방침을 변경할 권리가 있다는 데 동의합니다. 회사는
                개인정보 보호정책의 변경 사항에 대해 고객에게 자유롭게 통지할 수
                있습니다. 회사의 웹사이트에 업데이트된 버전의 개인정보 보호정책이
                게시되는 것은 고객에게 변경사항에 대한 유효한 통지로 간주됩니다.
                고객은 회사의 웹사이트와 개인 정보 보호 정책에 대한 업데이트를
                정기적으로 검토할 것을 의뢰합니다. 2. 개인정보보호정책 개정은
                개인정보보호정책에 명시된 날에 효력을 가지게 됩니다. 3. 본 개인정보
                보호정책은 맨 위에 표시된 날짜에 마지막으로 업데이트되었습니다.
                그것은 모든 이전 버전을 대체합니다.`}
          </PreText>
        </Wrapper>
      </RsWrapper>
