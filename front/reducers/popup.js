...
export const initailState = {
  ...
  //
  st_popupViewerLoading: false,
  st_popupViewerDone: false,
  st_popupViewerError: null,
};
...
export const POPUP_VIEWER_REQUEST = "POPUP_VIEWER_REQUEST";
export const POPUP_VIEWER_SUCCESS = "POPUP_VIEWER_SUCCESS";
export const POPUP_VIEWER_FAILURE = "POPUP_VIEWER_FAILURE";
...
const reducer = (state = initailState, action) =>
  produce(state, (draft) => {
    switch (action.type) {
      ...
      ///////////////////////////////////////////////////////
      case POPUP_VIEWER_REQUEST: {
        draft.st_popupViewerLoading = true;
        draft.st_popupViewerDone = null;
        draft.st_popupViewerError = false;
        break;
      }
      case POPUP_VIEWER_SUCCESS: {
        draft.st_popupViewerLoading = false;
        draft.st_popupViewerDone = true;
        draft.viewer = action.data;
        break;
      }
      case POPUP_VIEWER_FAILURE: {
        draft.st_popupViewerLoading = false;
        draft.st_popupViewerDone = false;
        draft.st_popupViewerError = action.error;
        break;
      }
      ///////////////////////////////////////////////////////
